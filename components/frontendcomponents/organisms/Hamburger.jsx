        ...
        <div className="nav-list">
          ...
          >
            ...
            <div className="dropdown-menu-ham">
              <ul>
                <li>
                  <Link href="/service-details">Coal & Coke</Link>
                </li>
                <li>
                  <Link href="/service-details">Handing & Logistic</Link>
                </li>
                <li>
                  <Link href="/service-details">IRON ORE</Link>
                </li>
                <li>
                  <Link href="/service-details">BIO-Fuel</Link>
                </li>
              </ul>
            </div>
          </li>
